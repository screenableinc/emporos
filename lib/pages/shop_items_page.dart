...
class _ShopItemsPageState extends State<ShopItemsPage> {
  ...
  Future loadData() async{
    ...
    final productList =await prefs.getString('products');
    //convert productlist back to JSON
    List<dynamic> asJSON= jsonDecode(productList.toString());
          ...
          future:loadData(), builder: (context, snapshot){
            if(snapshot.hasData){
              ...
              return ListView.builder(physics: ClampingScrollPhysics(),shrinkWrap: true,itemBuilder: (context,index){
                return ShopItem(product: snapshot.data[index],);
              },
                          ...
                          (
                            ...
                            [
                              ...
                              (
                                ...
                                children: <Widget>
                                [
                                  Text(product['productName'], style: TextStyle(color: Colors.blueAccent)),
                                  Row
                                  (
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: <Widget>
                                    [
                                      Text("K"+product['price'].toString(), style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0)),
                        ...
                        (
                          ...
                          child: ClipRRect(
                            ...
                            child: Image(
                              fit: BoxFit.cover,
                              image:
                              NetworkImage(Globals.picturesUrl+"?productId="+product['productId']),),
                          ),
                        ),
                      ),
                    ),
                    ...
                    (
                      ...
                      (
                        ...
                        (
                          ...
                          shadowColor: Color(0x802196F3),
                          shape: CircleBorder(),
                          child: ClipRRect(child: Image.asset('res/shoes1.png')),
                        ),
                      ),
                    ),
                  ),
